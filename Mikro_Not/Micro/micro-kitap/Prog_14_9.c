// *****************************************************************
// Dosya Adý		: 14_9.c
// Açýklama		: Rotary pulse encoder uygulamasý
...
void init()
{
   LCD_Config(&PORTB,4,5,7,3,2,1,0);  // LCD baðlantýsý tanýmlanýyor
...
// çevrilmiþ ise sayac deðerini artýrýr, sola çevrildi ise sayacý 
// azaltýr ve sayac deðerini LCD'de görüntüler. Herhangi bir 
...
// saða doðru çevrilmiþtir, bu durumda sayac 9999'dan küçükse artýr.
